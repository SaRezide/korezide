<template>
    <div class="home">
        <div class=" bg-white">
                <div class="d-flex align-items-center dash-header mt-0 border-bottom bg-white">
                    <span class="edit-icon  ms-3 my-2" @click="Back">
                        <i class="fa-solid fa-arrow-left text-black"></i>
                    </span>
                    <span style="flex: auto" class="">
                        <h6 style="font-size: 16px"  class="mb-0 text-center">Inscrire mon établissement</h6>
                    </span>
                    
                </div>
            <!-- ======================= Page Banner START -->
                        <section class="pt-4 pt-md-5 pb-0 mt-2">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 mx-auto text-center">
                                        <h3 class="fs-0 mb-2">Ajouter une nouvelle résidence</h3>
                        ...
                        <section>
                            <div class="row">
                                <div class="col-lg-10 p-3">
                                        <el-steps :active="active" finish-status="success" class="p-2">
                                            <el-step title="Étape 1" description="Général" >a</el-step>
                                            <el-step title="Étape 2" description="Disposition & tarification">b</el-step>
                                            <el-step title="Étape 3" description="Equipements & services">c</el-step>
                                            <el-step title="Étape 4" description="Photos">d</el-step>
                                        </el-steps>
    
                                        <div class="step_zone" v-if="active === 0" style="padding: 10px">
                                        <h3 style="font-size:18px; line-height: 32px; font-weight: 500; text-align: center">
                                            Bienvenue {{users.nom }}&nbsp;!
                                        </h3>
                                        ...
                                        <el-row>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="input-group">
                                                                <input maxlength="35" class="form-control" placeholder="Nom de votre résidence" v-model="biens.libelle">
                                                            </div>
                                                            ...
                                                            <input autocomplete="contact_phone" v-model="biens.cnt_prop_item" autofocus
                                                                ...
                                                                <label class="form-label" style="margin-top: 5px">
                                                                    ...
                                                                    <div id="non-whatsapp-field" v-if="isWhatsApp === false">
                                                                        ...
                                                                        <input class="form-control" type="tel" id="non-whatsapp-number" v-model="nonWhatsAppNumber">
                                                                    </div>
                                                                    <div id="whatsapp-field" v-if="isWhatsApp === true">
                                                                        ...
                                                                        <input class="form-control" type="tel" id="whatsapp-number" v-model="whatsappNumber">
                                                                    </div>
                                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select autocomplete="city" autofocus
                                                                v-model="biens.commune_item"
                                                                class="form-control" name="city">
                                                                <option value="" selected>Choisir une Commune/Zone</option>
                                                                ...
                                                                <option value="II Plateau">II Plateau</option>
                                            ...
                                            <el-button v-if="active === 0" @click="next" type="primary" style="width: 100%; margin-top: 10px; font-size: 18px">Suivant <i class="el-icon-arrow-right el-icon-right"></i></el-button>
    
                                        </div>
    
                                        <div class="step_zone" v-if="active === 1" style="padding: 10px">
                                        <h1 style="font-size: 18px; line-height: 32px; font-weight: 700;">
                                        ...
                                        <el-row>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select autocomplete="residency_name_1" autofocus
                                                                ...
                                                                <option value="2 PIECES">2 PIECES
                                                                </option>
                                                                <option value="3 PIECES">3 PIECES
                                                                </option>
                                                                <option value="4 PIECES">4 PIECES
                                                                </option>
                                            ...
                                            <div class="card shadow" style="margin-top: 15px">
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control" value="10:30" v-model="biens.horaire_jour_entre" placeholder="Horaire de rentrée" type="time">
                                                            <input class="form-control" value="13:30" v-model="biens.horaire_jour_sorti" placeholder="Horaire de sortie" type="time">                                               
                                                        </div>
                                                        </div>
                                            ...
                                            <el-row>
                                            <el-col :span="11">
                                                <el-button v-if="active === 1" @click="prec" type="warning" style="width: 100%; margin-top: 10px; font-size: 18px"><i class="el-icon-back el-icon-back"></i> Précédente</el-button>
                                            </el-col>
                                            <el-col :span="1">.</el-col>
                                            <el-col :span="12">
                                                <el-button v-if="active === 1" @click="next" type="primary" style="width: 100%; margin-top: 10px; font-size: 18px">Suivant <i class="el-icon-arrow-right el-icon-right"></i></el-button>
                                            </el-col>
                                            </el-row>
                                        ...
                                        <div class="step_zone" v-if="active === 2" style="padding: 10px">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <el-row>
                                            <el-col :span="11">
                                                <el-button v-if="active === 2" @click="prec" type="warning" style="width: 100%; margin-top: 10px; font-size: 18px"><i class="el-icon-back el-icon-back"></i> Précédente</el-button>
                                            </el-col>
                                            <el-col :span="1">.</el-col>
                                            <el-col :span="12">
                                                <el-button v-if="active === 2" @click="next" type="primary" style="width: 100%; margin-top: 10px; font-size: 18px">Suivant <i class="el-icon-arrow-right el-icon-right"></i></el-button>
                                            </el-col>
                                            </el-row>
                                            
                                        </div>
    
                                        <div class="step_zone" v-if="active === 3" style="padding: 10px">
                                        <h1 style="font-size: 40px">
                                            Photos
                                        </h1>
                                        <p style="font-size: 20px">
                                            Photos des résidnces
                                        </p>
                                        <el-row>
                                            ...
                                            <div class="card shadow">
                                                <!-- Card header -->
                                                <div class="card-header border-bottom">
                                                    <h5 class="mb-0">Photos <span style="font-size: 11px">(importer jusqu'a 8 images)</span></h5>
                                                </div>
                                                            ...
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="row g-2">
                                                                        ...
                                                                        <div class="col-12" v-if="biens.image1.length >= 2">
                                                                            ...
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/261101/pexels-photo-261101.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" >
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image1 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 1</vs-chip>
                                                                        ...
                                                                        <!-- Image -->
                                                                        <div class="col-12" v-if="biens.image2.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/261101/pexels-photo-261101.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image2 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 2</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <!-- Image -->
                                                                        <div class="col-md-6" v-if="biens.image3.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image3 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 3</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <!-- Images -->
                                                                        <div class="col-md-6" v-if="biens.image4.length >= 2">
                                                                            <div class="card card-grid-sm overflow-hidden" :style="{ 'background-image': 'url(' + biens.image4 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                <!-- Background overlay -->
                                                                                <vs-chip style="position: absolute">Image 4</vs-chip>
                                                                        ...
                                                                        <div class="col-md-6" v-if="biens.image5.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image5 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 5</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-6" v-if="biens.image6.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image6 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 6</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-6" v-if="biens.image7.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image7 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 7</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-6" v-if="biens.image8.length >= 2">
                                                                            <a data-glightbox data-gallery="gallery" href="https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                                                                <div class="card card-grid-sm card-element-hover card-overlay-hover overflow-hidden" :style="{ 'background-image': 'url(' + biens.image8 + ')', 'background-position': 'center left', 'background-size': 'cover' }">
                                                                                    <!-- Card hover element -->
                                                                                    <vs-chip style="position: absolute">Image 8</vs-chip>
                                                                                    <div class="hover-element position-absolute w-100 h-100">
                                                                                        <i class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div style="margin-top: 20px">
                                                                    <div v-if="numImage1">
                                                                        <el-button @click="$refs.uploadfile1.click()" style="width: 100%" round>Ajouter une image</el-button>
                                                                        <input ref="uploadfile1" id="uploadfile-1" class="form-control" @change="uploadImage($event, 1)" type="file" style="display:none;">
                                                                        
                                                                    </div>
                                                                    <div v-if="numImage2">
                                                                        <el-button @click="$refs.uploadfile2.click()" style="width: 100%" round>Ajouter d'autres images</el-button>
                                                                        <input ref="uploadfile2" id="uploadfile-1" class="form-control" @change="uploadImage($event, numImage)" type="file" style="display:none;">
                                                                    </div>
                                            ...
                                            <el-row>
                                            <el-col :span="11">
                                                <el-button v-if="active === 3" @click="prec" type="warning" style="width: 100%; margin-top: 10px; font-size: 18px"><i class="el-icon-back el-icon-back"></i> Précédente </el-button>
                                            </el-col>
                                            <el-col :span="1">.</el-col>
                                            <el-col :span="12">
                                                <el-button v-if="active === 3" @click="submitForm()" type="success" style="width: 100%; margin-top: 10px; font-size: 18px">Finaliser</el-button>
                                            </el-col>
                                            </el-row>
  ...
  export default {
      ...
      uploadImage(e, a) {
        console.log('choix');
            ...
            .then(res => {
                ...
                if(a == 5) {
                  this.chargeFichier1 = 2;
                  this.biens.image5 = res.data.url;
                  //this.sendPhotoToServer();
                }
                if(a == 6) {
                  this.chargeFichier1 = 2;
                  this.biens.image6 = res.data.url;
                  //this.sendPhotoToServer();
                }
                if(a == 7) {
                  this.chargeFichier1 = 2;
                  this.biens.image7 = res.data.url;
                  //this.sendPhotoToServer();
                }
                if(a == 8) {
                  this.chargeFichier1 = 2;
                  this.biens.image8 = res.data.url;
                  //this.sendPhotoToServer();
                }
                this.numImage1 = false;
                this.numImage2 = true;
                this.numImage++;
                if(this.numImage == 9) {
                    this.numImage2 = false;
                }
    ...
    submitForm() {
        if(this.active === 3) {
            this.biens.autorisation= 'oo';
            if(this.biens.image1 === '' || this.biens.image2 === '' || this.biens.image3 === '') {
                this.erreurImage = true;
                this.$vs.notify({title:'Image Manquant',text:'Ajoutez (3) Images minimum',color:'danger',position:'top-center'})
                this.scrollToTop();
            } else {
                this.erreurImage = false;
