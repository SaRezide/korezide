                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 mx-auto text-center">
                                <h1 class="fs-2 mb-2">Modifiez votre résidence</h1>
                            ...
                            <div class="col-lg-10 mx-auto">
                                 <el-steps :active="active" finish-status="success">
                                        ...
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3">
                                                    ...
                                                    <hr>
                                                    <!-- Owner name -->
                                                    <legend>Informations de contact pour cette résidence</legend>
                                                    <div class="col-12">
                                                    ...
                                                    <hr>
                                                    <legend>Où se trouve votre résidence ?</legend>
                                                    <!-- Address -->
                                                    <div class="col-md-6">
                                  ...
                                  <div class="step_zone" v-if="active === 2">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <legend>Équipements par catégorie</legend>
                                            <div class="describe-block">
                                                <p class="describe-text">
  ...
  export default {
    ...
    computed: {
      ...
      return this.$store.state.users;
        ...
        biens() {
      return this.$store.state.biensm;
        }
      },
    data() {
      return {
    ...
    showWhatsAppField() {
      ...
      next() {
        if(this.active === 0) {
            ...
            if(!this.erreurLibelle && !this.erreurNom && !this.erreurContact && !this.erreurAdresse && !this.erreurVille) {
                ...
                this.$store.commit('BienModif', this.biens);
                this.scrollToTop();
                this.$store.commit('ActiveForm', this.active);
            } else {
                this.$vs.notify({title:'Champ Vide',text:'Renseigné tous les champs',color:'danger',position:'top-center'})
                this.scrollToTop();
            }
        }
            ...
            if(this.biens.image1 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450283/2024120173149422.jpg' || this.biens.image2 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450290/2024120173175629.jpg' || this.biens.image3 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450296/2024120173195235.jpg' || this.biens.image4 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450305/2024120173196943.jpg') {
                ...
                this.$store.commit('BienModif', this.biens);
                this.$vs.notify({title:'Champ Vide',text:'Ajoutez les quatres (4) Images',color:'danger',position:'top-center'})
                this.scrollToTop();
            } else {
                this.$store.commit('BienModif', this.biens);
      ...
      VideChamp() {
        this.$store.commit('BienModif', this.data_r);
      },
    ...
    showPosition(position) {
      ...
      this.biens.localisation_latitude = latitude;
      this.biens.localisation_longitude = longitude;
      // Vous pouvez utiliser ces valeurs comme vous le souhaitez, par exemple, les stocker dans une variable ou les envoyer à votre serveur.
    },
    ...
    submitForm() {
        if(this.active === 3) {
            ...
            if(this.biens.image1 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450283/2024120173149422.jpg' || this.biens.image2 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450290/2024120173175629.jpg' || this.biens.image3 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450296/2024120173195235.jpg' || this.biens.image4 === 'http://res.cloudinary.com/r-sidence-meubl-e/image/upload/v1708450305/2024120173196943.jpg') {
                ...
                this.$axios.put('/biens.php', this.biens)
                .then(response => {
