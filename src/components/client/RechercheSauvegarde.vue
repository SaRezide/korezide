		...
		<div v-if="isMobile">
			<div class="d-flex align-items-center dash-header mt-2 border-bottom bg-white">
                    ...
                    <span style="flex: auto" class="">
                        <h6 style="font-size: 16px"  class="mb-0 text-center">Mes recherches sauvegardées</h6>
                    </span>
                </div>
				...
				<div class="p-3">
						...
						<div class="empty mb-8">
                          ...
                          <div class="d-grid justify-content-center text-center">
                            <H6>Vous n'avez pas encore effectué de recherches !</H6>
                            <p class="text-wrap">Découvrez les meilleurs établissements partours en Côte d'ivoire</p>
                            <vs-button to="/" style="background: #348ddb !important" class="fw-semibold">Commencer maintenant</vs-button>
                          </div>
                        </div>
					...
					<div class="col-lg-8 col-xl-9">
						...
						<div class="card menu-account">
							...
							<div class="card-header border-bottom">
								<h4 class="card-header-title">Mes recherches sauvegardées</h4>
							</div>
